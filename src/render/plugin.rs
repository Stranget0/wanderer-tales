...
//
// use crate::{render::map::*, utils::QUAD_TREE_DIRECTIONS};
// use bevy::{
//     prelude::*,
//     render::{
...
//         let map_lod = world.resource::<MapLOD>();
//         let offset = world
...
//             .xz();
//
//         let mut data: Vec<[f32; 2]> = Vec::with_capacity(map_lod.leafs.len() * 4);
//         for leaf in map_lod.leafs.iter() {
//             let center = leaf.pos + offset;
//             for corner in QUAD_TREE_DIRECTIONS.iter() {
//                 let corner_offset = *corner * 0.5 * leaf.size;
//                 let corner_pos = center + corner_offset;
//                 data.push([corner_pos.x, corner_pos.y]);
//             }
//         }
//
...
//         let size = buffers.gpu_buffer.size();
//
